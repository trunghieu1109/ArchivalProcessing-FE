---
name: maintain-frontend-ui-system
description: "Maintain shared UI primitives, global styles, theme tokens, utility composition, accessibility, and presentation-only contracts. Use when working on UI component, shared button, global CSS, theme token, accessibility, shadcn primitive."
---

# Maintain Frontend Ui System
...
Recommended overlays: `$verify-frontend-changes`.
