---
name: review-frontend-cross-step-changes
description: "Review changes that propagate across digitization, dossiers, numbering, artifacts, publication, routing, cache, or API contracts. Use when working on frontend impact analysis, cross-step change, stale downstream UI, workflow review."
---

# Review Frontend Cross Step Changes
