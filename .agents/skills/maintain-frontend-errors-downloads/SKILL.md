---
name: maintain-frontend-errors-downloads
description: "Maintain capability error mapping, conflict feedback, Blob and signed-URL downloads, filenames, preview URLs, and cleanup. Use when working on frontend error mapping, conflict message, Blob download, signed URL, filename, object URL cleanup."
---

# Maintain Frontend Errors Downloads
