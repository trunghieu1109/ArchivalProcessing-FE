---
name: maintain-frontend-upload-managers
description: "Maintain ZIP and folder upload managers, providers, contexts, concurrency, persistence, events, pause, retry, and global docks. Use when working on upload manager, upload provider, upload context, semaphore, pause upload, retry upload."
---

# Maintain Frontend Upload Managers
