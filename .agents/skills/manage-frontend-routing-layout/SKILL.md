---
name: manage-frontend-routing-layout
description: "Maintain routes, route guards, layouts, session and step URL identity, navigation, and fallback behavior. Use when working on frontend route, route guard, layout, sessionId URL, step route, navigation."
---

# Manage Frontend Routing Layout
...
Recommended overlays: `$manage-frontend-auth`, `$maintain-frontend-cache-hydration`.
