---
name: manage-frontend-publication
description: "Maintain Step 7 publication manifest, standard-name editing, selection, archive generation, stale state, scoped download, and rollback. Use when working on Step 7, publication UI, manifest, standard name, archive ZIP, scoped download."
---

# Manage Frontend Publication
...
Recommended overlays: `$maintain-frontend-errors-downloads`, `$maintain-frontend-polling`.
Linked backend skills: `$publish-archival-documents`. Load them only when the server contract or behavior is in scope.
