---
name: manage-frontend-zip-upload
description: "Maintain ZIP staging, progress, concurrency, retry, cancellation, completion, interruption display, and ingestion handoff. Use when working on ZIP upload UI, ZipUploadManager, upload progress, retry ZIP, cancel upload, interruption."
---

# Manage Frontend Zip Upload
...
Linked backend skills: `$manage-archival-uploads`. Load them only when the server contract or behavior is in scope.
