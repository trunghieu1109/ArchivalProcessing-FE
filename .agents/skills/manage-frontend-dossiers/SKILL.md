---
name: manage-frontend-dossiers
description: "Maintain Step 4 cluster versions, polling, dossier tree, selection, metadata, suggestions, retention, classification, and warnings. Use when working on Step 4, dossier tree, cluster version, dossier suggestion, retention suggestion, manual classification."
---

# Manage Frontend Dossiers
...
Recommended overlays: `$maintain-frontend-polling`, `$manage-frontend-dossier-feedback`.
Linked backend skills: `$manage-archival-dossiers`, `$manage-dossier-classification`, `$suggest-archival-dossiers`, `$suggest-retention-periods`. Load them only when the server contract or behavior is in scope.
