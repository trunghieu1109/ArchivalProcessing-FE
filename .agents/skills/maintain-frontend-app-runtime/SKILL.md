---
name: maintain-frontend-app-runtime
description: "Maintain application bootstrap, global providers, theme wiring, PDF worker setup, environment access, and runtime initialization. Use when working on main.tsx, provider, theme provider, PDF.js worker, Vite environment, app bootstrap."
---

# Maintain Frontend App Runtime
...
Recommended overlays: `$build-deploy-frontend`.
