---
name: manage-frontend-auth
description: "Maintain login, token storage, current-user hydration, logout, role visibility, and authenticated request behavior. Use when working on login page, auth token, current user, logout, role guard, auth storage."
---

# Manage Frontend Auth
...
Recommended overlays: `$maintain-frontend-http-client`.
