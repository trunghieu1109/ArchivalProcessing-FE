---
name: navigate-archival-frontend
description: "Route frontend work across shell/access, workflow capabilities, data/runtime concerns, and engineering governance. Use when working on frontend architecture, broad frontend change, unknown UI ownership, end-to-end browser workflow."
---
