---
name: manage-frontend-numbering
description: "Maintain Step 5 page or sheet mode, styles, bulk preview, corrections, row status, revision conflicts, and saved-state timeline. Use when working on Step 5, numbering UI, page mode, sheet mode, numbering preview, numbering timeline."
---

# Manage Frontend Numbering
...
Recommended overlays: `$maintain-frontend-polling`, `$review-frontend-cross-step-changes`.
Linked backend skills: `$manage-document-numbering`, `$import-dossier-metadata-xlsx`. Load them only when the server contract or behavior is in scope.
