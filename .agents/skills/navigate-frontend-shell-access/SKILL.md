---
name: navigate-frontend-shell-access
description: "Route app bootstrap, routes, layouts, authentication, administration, sessions page, and shared UI-system work. Use when working on app shell, routing, login, admin, sessions page, theme, shared UI."
---

# Navigate Frontend Shell Access
