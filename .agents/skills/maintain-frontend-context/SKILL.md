---
name: maintain-frontend-context
description: "Maintain the frontend skill hierarchy, manifests, catalog, ownership maps, backend links, drift checks, and verification metadata. Use when working on frontend skill, frontend context manifest, skill catalog, stale frontend context, ownership drift."
---

# Maintain Frontend Context
