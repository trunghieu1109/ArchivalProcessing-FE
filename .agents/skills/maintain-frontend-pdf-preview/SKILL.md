---
name: maintain-frontend-pdf-preview
description: "Maintain PDF.js loading, rendering, resize, page selection, object URLs, cancellation, and preview-resource cleanup. Use when working on PDF preview, PDF.js, object URL, render cancellation, document preview, resize."
---

# Maintain Frontend Pdf Preview
