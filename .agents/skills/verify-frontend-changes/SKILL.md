---
name: verify-frontend-changes
description: "Select and run focused Vitest tests, policy tests, typecheck, lint, production build, and route or role smoke checks. Use when working on verify frontend, run frontend tests, typecheck, lint, Vite build, smoke test."
---
