---
name: manage-frontend-dossier-feedback
description: "Maintain dossier feedback, document moves, manual classification, metadata correction, pending state, refresh, and rebuild actions. Use when working on dossier feedback UI, move document, manual classification dialog, dossier correction, rebuild result."
---

# Manage Frontend Dossier Feedback
...
Recommended overlays: `$review-frontend-cross-step-changes`.
Linked backend skills: `$manage-dossier-feedback`, `$edit-dossier-metadata`. Load them only when the server contract or behavior is in scope.
