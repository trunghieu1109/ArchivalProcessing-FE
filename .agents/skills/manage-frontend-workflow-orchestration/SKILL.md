---
name: manage-frontend-workflow-orchestration
description: "Maintain step routing, lifecycle, progress, requirements, workflow policy, action coordination, auto-start, and cross-step navigation. Use when working on UploadPage, step transition, workflow policy, requirements, auto-start, progress timeline."
---

# Manage Frontend Workflow Orchestration
...
Recommended overlays: `$maintain-frontend-cache-hydration`, `$maintain-frontend-polling`.
Linked backend skills: `$manage-archival-sessions`. Load them only when the server contract or behavior is in scope.
