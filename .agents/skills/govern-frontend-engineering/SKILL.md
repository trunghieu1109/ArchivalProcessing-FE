---
name: govern-frontend-engineering
description: "Route frontend verification, refactoring, context maintenance, build/deployment, and cross-step review. Use when working on frontend tests, frontend refactor, context drift, frontend build, cross-step review."
---

# Govern Frontend Engineering
