---
name: maintain-frontend-polling
description: "Maintain polling intervals, visibility awareness, terminal states, stale-response guards, dedupe, cancellation, and partial snapshots. Use when working on polling hook, job polling, page visibility, terminal state, stale response, polling cleanup."
---

# Maintain Frontend Polling
